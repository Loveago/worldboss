...
export default function DataOrdersPage() {
  ...
  const failedCount = orders.filter((o) => o.dataStatus === "FAILED").length;
    ...
    <div className="space-y-6">
      <section className="store-glass p-5 md:p-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="font-sora text-2xl text-slate-900">Data purchases</h1>
            <p className="text-sm text-slate-600">Track your data bundles and delivery status – updated automatically.</p>
          </div>
          <Link href="/data" className="store-outline px-4 py-2 text-sm w-fit bg-white/80">
            Buy more data
          </Link>
        </div>
      </section>
      ...
      {!ordersQuery.isLoading && !errorMessage && orders.length === 0 && (
        <div className="store-card p-4 text-sm text-slate-500">
          ...
          <Link href="/data" className="text-[var(--store-accent)]">
